...
from .projection_plotting import plot_tsne
...
parser.add_argument('--output_dir', type=str, default='figures/projections/tsne')
...
for name in args.dataset_name:
    ...
    plot_tsne(df, title, args.output_dir)
    print(f"-- saved tsne plot for {name} in {args.output_dir}")