...
from .projection_plotting import plot_umap
...
parser.add_argument('--output_dir', type=str, default='figures/projections/umap')
...
for name in args.dataset_name:
    ...
    plot_umap(df, title, args.output_dir)
    print(f"-- saved umap plot for {name} in {args.output_dir}")