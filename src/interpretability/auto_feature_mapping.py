...
def auto_map_features_to_entities(features: list, version: str = 'v2.11', 
    ...
    """
    embeddings_path = Path(f"models/executions/GSE54514_enriched_ontology_degfilter{version}") / f"{embedding_type}" / f"outputmodel_{embedding_type}_entity_embeddings.npy"
    entity_mapping_path = Path(f"models/executions/GSE54514_enriched_ontology_degfilter{version}") / f"{embedding_type}" / f"outputmodel_{embedding_type}_entity_mapping.csv"
