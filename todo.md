...
- [x] add random forest
- [ ] embed a pytroch model in MLModel instead of sklearn MLPClassifier
- [ ] fix non linearly seperable data issue with SVM on RGCN (figure an option to skip in gridsearch wo affectign other models)
